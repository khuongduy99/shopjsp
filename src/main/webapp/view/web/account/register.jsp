	        ...
	        <div class="row">
	          ...
	          <div class="col-lg-12">
	            <div class="p-3">
	              ...
	              <% if(confirm == null) { %>
	              <form onsubmit="return validateForm()" class="user" action="<%= request.getContextPath() + "/dangky" %>" method="post">
	              <% String message = (String) request.getAttribute("message"); %>
	               ...
	               <% UserModel user = (UserModel) request.getAttribute("userModel"); %>
	                ...
	                <div class="form-group">
	                    <input type="text" required value="<%= user != null ? user.getFullName() :  "" %>" class="form-control form-control-user" id="exampleLastName" name="fullname" placeholder="Họ tên">
	                  
	                </div>
	                <div class="form-group">
	                  <input type="email" required value="<%= user != null ? user.getEmail() :  "" %>" class="form-control form-control-user" id="exampleInputEmail" name="email" placeholder="Địa chỉ Email">
	                </div>
	                <div class="form-group row">
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                    <input type="password" class="form-control form-control-user" id="psw" name="password" placeholder="Mật khẩu" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
	                  </div>
	                  <div class="col-sm-6">
	                    <input type="password" class="form-control form-control-user" id="exampleRepeatPassword" required placeholder="Nhập lại mật khẩu">
	                    
	                  </div>
	                  <div id="messValidRepass" class="col-12 p-3 text-center mb-2" style="background-color: #f8d7da; border-radius: 10px; display: none">
								Mật khẩu nhập lại và mật khẩu không giống nhau
								</div>
	                </div>
	                
	              <div id="message" class="mb-3">
					  <h6 class="ml-3">Mật khẩu phải có chứa:</h6>
					  <p id="letter" class="invalid">Phải có ít nhât <b>1 chữ cái thường</b></p>
					  <p id="capital" class="invalid">Phải có ít nhât <b>1 chữ cái in hoa</b></p>
					  <p id="number" class="invalid">Phải có ít nhât <b>1 con số</b></p>
	                ...
	                <hr>
	                <a href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=https://jspweb.demo.jelastic.com/dangnhapbangGG&response_type=code&client_id=762420684607-sso3ff8r1tp1j2uramg24gvvqsnv9g17.apps.googleusercontent.com&approval_prompt=force" class="btn btn-google btn-user btn-block" class="btn btn-google btn-user btn-block">
	                  <i class="fab fa-google fa-fw"></i> Đăng ký với Google
	                </a>
	                <a href="index.html" class="btn btn-facebook btn-user btn-block">
	                  <i class="https://www.facebook.com/dialog/oauth?client_id=608201396794677&redirect_uri=https://jspweb.demo.jelastic.com/dangnhapbangFB"></i> Đăng ký với Facebook
	                </a>
	              </form>
